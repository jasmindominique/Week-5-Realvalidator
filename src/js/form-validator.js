class FormValidator{
	constructor(){
		...
		RequiredCharacterValidator.init('[data-validate=characters', '[@], [.], [!]) //Computer: once the browser runs the required field validator, it'll then run required character validator, the browser will then look for init in input validator. init is our constructor so that we can apply that logic to everything in the field. 
	}
}